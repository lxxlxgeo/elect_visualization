...
class RlDas_Reader(object):
    def __init__(self, start_time, end_time, step):
        ...
        :param start_time: 预报开始时间
        :param end_time: 预报结束时间
        :param step:  预报步长
        '''
        # 开始时间
        ...
        self.step = step  # 预报步长
        self.filepath = r'G:\heilongjiang_project\RLDAS\source_data'  # rldas 文件路径 这里需要改下
    ...
    def __get__wrf_files_info(self):
        ...
        if (hours > 16) | (hours < 4):
            ...
            full_path=r'G:\heilongjiang_project\RLDAS\source_data'
