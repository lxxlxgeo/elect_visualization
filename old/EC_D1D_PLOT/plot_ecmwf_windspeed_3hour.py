...
# print(lat)
    fg310 = data["fg310"][:,:].sel(latitude=slice(latN,latS),longitude=slice(lonW,lonE))
...
# print(pre)
    ...
    a = ax.contourf(lon, lat, fg310,levels=np.arange(0,35,2),cmap=cmaps.wind_17lev)
    ######获取path#######################
    ...
    cb.update_ticks()  
    plt.savefig("E:/EC/heilongjiang_2023072308_"+str(step)[0:2]+"_3hour_windspeed.png",bbox_inches='tight', pad_inches = 0.2)