...
for i in range(0, len(cape) - 1):
    ...
    plotter = Plotter(fpath, variable_name[0], city_path=city_path,variables=variable_name ,province_path=province_path, forecast_type=forecast_type)
    ...
    plotter = Plotter(fpath, variable_name[1], city_path=city_path,variables=variable_name ,province_path=province_path, forecast_type=forecast_type)
    levels=[0, 0.1, 1, 3, 10, 20, 50, 70]
    ...
    plotter = Plotter(fpath, variable_name[2], city_path=city_path,variables=variable_name ,province_path=province_path, forecast_type=forecast_type)
