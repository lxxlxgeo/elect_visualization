...
# %%
import datetime
from srcmain.data_reader import GribDataReader
from srcmain.data_plotter import Plotter
import numpy as np
import cmaps
import os
...
manual_time = datetime.datetime(2023, 7, 28,17)  # 手动运行时指定的起报时刻（utc-8）
# 中期天气预报 24 小时间隔
forecast_step = 24
end = 190
...
output_prefix=os.path.join(output_prefix,manual_time.strftime('%Y%m%d'))
