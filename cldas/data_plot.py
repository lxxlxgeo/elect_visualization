...
from un_config.cldas_config import extent
...
# %%
class Plotter:
    def __init__(self, variable_name, variables, ticks, forecast_path_str,forecast_type='short-term'):
        '''
        :param fpath: 没搞懂这是啥
    ...
    def add_map_features(self, ax):
        ...
        ax.set_xticks(np.arange(extent[0], extent[1],0.5), crs=ccrs.PlateCarree())
        ax.set_yticks(np.arange(extent[2], extent[3],0.5), crs=ccrs.PlateCarree())
