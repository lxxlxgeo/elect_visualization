'''
Date         : 2023-07-28 16:56:24
LastEditors  : ChenKt
LastEditTime : 2023-07-28 16:58:33
FilePath     : /elect_visualization/short-term_24h_forecast_elements_plotter.py
Aim          :
Mission      :
'''
'''
...
plotter = Plotter(fpath, variable_name[0], city_path=city_path,variables=variable_name ,province_path=province_path,forecast_step=24, forecast_type=forecast_type)
...
plotter = Plotter(fpath, variable_name[1], city_path=city_path,variables=variable_name ,province_path=province_path,forecast_step=24, forecast_type=forecast_type)
levels=[0, 0.1, 1, 3, 10, 20, 50, 70]
...
plotter = Plotter(fpath, variable_name[2], city_path=city_path,variables=variable_name ,province_path=province_path,forecast_step=24, forecast_type=forecast_type)
